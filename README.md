...
<html lang="pt-br" dir="ltr">
  ...
  <head>
    <title>Filmov - Filmes e Séries Online</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div class="topo conteudo-flex">
        ...
        <div class="topo-esquerdo conteudo-flex">
          <!-- início do logo -->
          <div class="topo-logo">
            <img src="./image/filmov.png" alt="Imagem logotipo da filmov" title="Imagem logotipo da filmov">
          </div>
          <!-- fim do logo -->
        </div>
    ...
    <!-- fim do topo -->
      ...
      <div class="elementos conteudo-flex">
        <div class="capa">
          <a href="./html/01-filme.html"><img src="./image/01-capa.jpg" alt="imagem modelo capa de filme" title="imagem modelo capa de filme"></a>
        </div>
        <div class="capa">
          <a href="./html/07-serie.html"><img src="./image/07-capa.jpg" alt="imagem modelo capa de série" title="imagem modelo capa de série"></a>
        </div>
        <div class="capa">
          <a href="./html/02-filme.html"><img src="./image/02-capa.jpg" alt="imagem modelo capa de filme" title="imagem modelo capa de filme"></a>
        </div>
        <div class="capa">
          <a href="./html/08-serie.html"><img src="./image/08-capa.jpg" alt="imagem modelo capa de série" title="imagem modelo capa de série"></a>
        </div>
        <div class="capa">
          <a href="./html/03-filme.html"><img src="./image/03-capa.jpg" alt="imagem modelo capa de filme" title="imagem modelo capa de filme"></a>
        </div>
        <div class="capa">
          <a href="./html/09-serie.html"><img src="./image/09-capa.jpg" alt="imagem modelo capa de série" title="imagem modelo capa de série"></a>
        </div>
      </div>
      <!-- fim destaque -->

      <!-- início dados da empresa -->
      <div class="dados-empresa">

        <div class="">
          <h1>Você sabe o que é a Filmov?</h1>
        </div>
        <div class="">
          <p>
            A Filmov é um serviço provedor online de filmes e séries com a mais ampla variedade para a sua escolha.
          </p>
        </div>
        <div class="">
        ...
        <div class="">
          <p>
            Você pode desfrutrar de todas as vantagens:
          </p>
        </div>

          <!-- início caixas vantagens -->
      ...
      <div class="elementos conteudo-flex">
        <div class="video">
          <div class="embed-vid">
            <iframe src="https://www.youtube.com/embed/3iDIdua0yy8"></iframe>
          </div>
        </div>
        <div class="video">
          <div class="embed-vid">
            <iframe src="https://www.youtube.com/embed/csJeJ8Af53k"></iframe>
          </div>
        </div>
      </div>
      <!-- fim elemento -->
    ...
    <footer>
      ...
      <div>
        <p>2020 - Filmov S.A. by <a href="https://jonasmzsouza.github.io/">Jonas Souza</a></p>
